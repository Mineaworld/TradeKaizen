...
-- Add columns for net PnL and risk/reward ratio to journal_entries if not exists
ALTER TABLE journal_entries ADD COLUMN IF NOT EXISTS net_pnl NUMERIC;
ALTER TABLE journal_entries ADD COLUMN IF NOT EXISTS risk_reward_ratio NUMERIC;
